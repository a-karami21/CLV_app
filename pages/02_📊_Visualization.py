    ...
    with st.container():
        ...
        with tab1:
            ...
            if ss.df_viz_list is not None:
                customers_name = ss.df_viz_list[0]['ec_eu_customer_n']
                ...
                customer_id_input = ss.df_viz_list[0].loc[ss.df_viz_list[0].ec_eu_customer_n == customer_name_input, 'ec_eu_customer'].values[0]
            ...
            df1C = ss.df_list[0][ss.df_list[0]["ec_eu_customer"] == custID]

            # X selected customer: cumulative transactions
            max_date = ss.df_list[0]["order_intake_date"].max()
            min_date = ss.df_list[0]["order_intake_date"].min()
            span_days = (max_date - min_date).days

            # history of the selected customer: probability over time of being alive
            st.write(ss.customer_name_input)
            plt.figure(figsize=(20 ,4))
            fig7 = plot_history_alive(model=ss.bgf_full_list[0],
                                        t=span_days,
                                        transactions=df1C,
            ...
            with st.container():
                ...
                df_rfm_customer = ss.df_viz_list[0][ss.df_viz_list[0]["ec_eu_customer"] == custID]
        ...
        with tab2:
            # Customer Selection
            if ss.df_viz_list is not None:
                customers_name = ss.df_viz_list[1]['ec_eu_customer_n']
                customer_name_input = st.selectbox("Select customer ID to see its purchase behavior", customers_name)
                ss.customer_name_input = customer_name_input
                customer_id_input = ss.df_viz_list[1].loc[ss.df_viz_list[1].ec_eu_customer_n == customer_name_input, 'ec_eu_customer'].values[0]
            ...
            df1C = ss.df_list[1][ss.df_list[1]["ec_eu_customer"] == custID]

            # X selected customer: cumulative transactions
            max_date = ss.df_list[1]["order_intake_date"].max()
            min_date = ss.df_list[1]["order_intake_date"].min()
            span_days = (max_date - min_date).days

            # history of the selected customer: probability over time of being alive
            st.write(ss.customer_name_input)
            plt.figure(figsize=(20 ,4))
            fig7 = plot_history_alive(model=ss.bgf_full_list[1],
                                        t=span_days,
                                        transactions=df1C,
                                        datetime_col="order_intake_date"
                                        )
            ...
            with st.container():
                ...
                df_rfm_customer = ss.df_viz_list[1][ss.df_viz_list[1]["ec_eu_customer"] == custID]
