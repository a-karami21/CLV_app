        ...
        with left_column3:
            ...
            for bu, tab in zip(ss.bu_list, tab_list):
                with tab:
                    ...
                    max_freq_product = ss.df_rft_list[bu]["frequency"].quantile(0.98)
                    max_rec_product = ss.df_rft_list[bu]["recency"].max()
                    max_mon_product = ss.df_rft_list[bu]["monetary_value"].quantile(0.98)
                    max_T_product = ss.df_rft_list[bu]["T"].max()

                    # training recency
                    fig4 = plt.figure(figsize=(5, 5))
                    ax = sns.distplot(ss.df_rft_list[bu]["recency"])
        ...
        with middle_column3:
            ...
            for bu, tab in zip(ss.bu_list, tab_list):
                with tab:
                    ...
                    ax = sns.distplot(ss.df_rft_list[bu]["frequency"])
        ...
        with right_column3:
            ...
            for bu, tab in zip(ss.bu_list, tab_list):
                with tab:
                    ...
                    ax = sns.distplot(ss.df_rft_list[bu]["monetary_value"])
        ...
        for bu, tab in zip(ss.bu_list, tab_list):
            with tab:
                ...
                if ss.df_viz_list is not None:
                    customers_name = ss.df_viz_list[bu]['ec_eu_customer_n']
                    ...
                    customer_id_input = ss.df_viz_list[bu].loc[ss.df_viz_list[bu].ec_eu_customer_n == customer_name_input, 'ec_eu_customer'].values[0]
                ...
                df1C = ss.df_list[bu][ss.df_list[bu]["ec_eu_customer"] == custID]

                # X selected customer: cumulative transactions
                max_date = ss.df_list[bu]["order_intake_date"].max()
                min_date = ss.df_list[bu]["order_intake_date"].min()
                span_days = (max_date - min_date).days

                # history of the selected customer: probability over time of being alive
                st.write(ss.customer_name_input)
                plt.figure(figsize=(20 ,4))
                fig7 = plot_history_alive(model=ss.bgf_full_list[bu],
                                            t=span_days,
                                            transactions=df1C,
                ...
                with st.container():
                    ...
                    df_rfm_customer = ss.df_viz_list[bu][ss.df_viz_list[bu]["ec_eu_customer"] == custID]
            ...
            with tab:
                ...
                with viz_left_column1:
                    ...
                    if industry_type_cust == "Energy":
                        df_top20 = ss.df_viz_list[bu][ss.df_viz_list[bu]['ec_eu_industry_type_n'].isin(['Energy'])]
                    elif industry_type_cust == "Material":
                        df_top20 = ss.df_viz_list[bu][ss.df_viz_list[bu]['ec_eu_industry_type_n'].isin(['Material'])]
                    elif industry_type_cust == "Life":
                        df_top20 = ss.df_viz_list[bu][ss.df_viz_list[bu]['ec_eu_industry_type_n'].isin(['Life'])]
                    elif industry_type_cust == "All":
                        df_top20 = ss.df_viz_list[bu]
                ...
                with viz_right_column1:
                    ...
                    if industry_type_cust == "Energy":
                        df_p_alive = ss.df_viz_list[bu][ss.df_viz_list[bu]['ec_eu_industry_type_n'].isin(['Energy'])]
                    elif industry_type_cust == "Material":
                        df_p_alive = ss.df_viz_list[bu][ss.df_viz_list[bu]['ec_eu_industry_type_n'].isin(['Material'])]
                    elif industry_type_cust == "Life":
                        df_p_alive = ss.df_viz_list[bu][ss.df_viz_list[bu]['ec_eu_industry_type_n'].isin(['Life'])]
                    elif industry_type_cust == "All":
                        df_p_alive = ss.df_viz_list[bu]

                    df_p_alive = df_p_alive[ss.df_viz_list[bu]["prob_alive"] < (ss.prob_alive_input)].reset_index()
    ...
    with st.container():
        ...
        for bu, tab in zip(ss.bu_list, tab_list):
            with tab:
                ...
                df_industry_viz = ss.df_viz_list[bu].groupby(['ec_eu_industry_type_n',
